...
int main(int argc, const char * argv[])
{
    ...
    GLAppearance* apperance_0 = new GLAppearance("../../data/shaders/multi_texture.vs", "noisemap.fs");
	...
	int texid = texture->loadAndCreateTextures("dragon.bmp", "water-texture.bmp");
