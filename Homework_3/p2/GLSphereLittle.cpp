...
#include "GLSphereLittle.h"




GLSphereLittle::GLSphereLittle(float center_x, float center_y, float center_z, float radius, int rows, int segments )
{
 ...
 */
void GLSphereLittle::initShader(void)
{
#ifdef _WIN32
    ...
    _light_source1._specular_intensity = 0.2;
    _light_source1._diffuse_intensity = 1.2;
    _light_source1._attenuation_coeff = 0.2;
