...
#include "GLSphereHighlight.h"




GLSphereHighlight::GLSphereHighlight(float center_x, float center_y, float center_z, float radius, int rows, int segments )
{
...
GLSphereHighlight::~GLSphereHighlight()
{
 ...
 */
void GLSphereHighlight::initShader(void)
{
#ifdef _WIN32
    ...
    _light_source1._ambient_intensity = 0.6;
    _light_source1._specular_intensity = 0.5;
    _light_source1._diffuse_intensity = 0.9;
    _light_source1._attenuation_coeff = 0.1;
